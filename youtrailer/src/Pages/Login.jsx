    ...
    <>
      <div className=" w-full h-screen">
        <img
          ...
          alt="background"
        />
        <div className=" bg-black/60 fixed top-0 left-0 w-screen"></div>
            ...
            <div className=" max-w-[320px] mx-auto py-16">
              ...
              >
                ...
                <p className=" py-8 text-gray-600">
                  <span>New to YouTrailer?</span>
                  <Link to="/signup" className=" text-white pl-5">
                    Sign Up
                  </Link>
                </p>
              </form>
              {error ? (
                <p className=" text-center p-3 text-red-600">
